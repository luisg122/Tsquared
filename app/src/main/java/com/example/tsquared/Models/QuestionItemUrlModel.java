...
public class QuestionItemUrlModel {
    ...
    QuestionItemUrlModel() {

    }
    public QuestionItemUrlModel(String topic, String question,
                                  String dateSubmitted, String responseNum, String profileImage, String urlImage, String headline, String source){
        this.topic    = topic;
