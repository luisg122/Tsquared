...
public class UserFollowingFragment extends BottomSheetDialogFragment
    ...
    private static String URL3 = "http://207.237.59.117:8080/TSquared/platform?todo=findFollowing";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view = View.inflate(getContext(), R.layout.user_following, null);
